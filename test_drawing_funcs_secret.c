...
void test_draw_pixel_green_blend(TestObjs *objs);
...
void test_draw_pixel(TestObjs *objs)
{
  ...
  objs->small.data[SMALL_IDX(2, 3)] = 0xAAAAAAFF;
  // Drawing semi-transparent cyan (0x00FFFFFF) over it
  draw_pixel(&objs->small, 2, 3, 0x00FFFF80); // 50% opacity
}
